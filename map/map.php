...
<body>
    ...
    <div id="sidebar">
        ...
        <div class="location-group">
            <!-- Modified to prevent showing anything when clicked -->
            <button class="btn btn-success category-button" type="button" id="myClassesBtn" style="background-color: #EEC643;">
                My Classes
            </button>
            <!-- No collapsible content here -->
        </div>
